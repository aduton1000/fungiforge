...
| W0.3 | Test framework and CI | built | develop: W0.3 commit | 127 unit tests (93 % coverage of bin/ + fungiforge/), 28 nf-test cases, lint 0 warnings, shellcheck clean, stub DAG, Docker fixture run; CI green on develop |
