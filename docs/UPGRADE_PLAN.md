...
| W2.1 | QC and verdict gating in the DAG | built | develop: `c98a0b4` | stub DAG + nf-test (forced non_fungal, forced QC fail, --force_all), unit test for the master column; real case (DF-003, bacterial) pending on the dev deployment |
