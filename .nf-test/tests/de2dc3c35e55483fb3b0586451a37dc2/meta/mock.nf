...
include { EXTRAS } from '/Users/brightadu/Documents/Claude/Projects/fungiforge/modules/stage13_extras.nf'
...
workflow {
    ...
    input = []
                ...
                input[0] = [[id:'S1', assembly_mode:'longread', compartment:'AIR', facility:'F1', season:'Dry'], file("/Users/brightadu/Documents/Claude/Projects/fungiforge/test/samplesheet.test.csv"), file("/Users/brightadu/Documents/Claude/Projects/fungiforge/test/reads/TESTFUN02.ont.fastq.gz"), file("/Users/brightadu/Documents/Claude/Projects/fungiforge/test/reads/TESTFUN02_R1.fastq.gz"), file("/Users/brightadu/Documents/Claude/Projects/fungiforge/test/reads/TESTFUN02_R2.fastq.gz")]
                
    //----

    //run process
    EXTRAS.run(input.toArray())

    if (EXTRAS.output){

        // consumes all named output channels and stores items in a json file
        EXTRAS.out.getNames().each { name ->
            serializeChannel(name, EXTRAS.out.getProperty(name), jsonOutput, params.nf_test_output)
        }	  

        // consumes all unnamed output channels and stores items in a json file
        def array = EXTRAS.out as List<Object>
        def i = 0
        array.each { output ->
