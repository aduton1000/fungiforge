...
include { PROVENANCE } from '/Users/brightadu/Documents/Claude/Projects/fungiforge/modules/stage15_provenance.nf'
...
workflow {
    ...
    input = []
                ...
                input[0] = file("/Users/brightadu/Documents/Claude/Projects/fungiforge/.nf-test/tests/2d9109c6fc0ee728fee07d367b5d5bbf/output/run_info.json")
                input[1] = file("/Users/brightadu/Documents/Claude/Projects/fungiforge/.nf-test/tests/2d9109c6fc0ee728fee07d367b5d5bbf/output/db_manifest.json")
                input[2] = [file("/Users/brightadu/Documents/Claude/Projects/fungiforge/.nf-test/tests/2d9109c6fc0ee728fee07d367b5d5bbf/output/S1.assemble.json"), file("/Users/brightadu/Documents/Claude/Projects/fungiforge/.nf-test/tests/2d9109c6fc0ee728fee07d367b5d5bbf/output/S2.assemble.json")]
                input[3] = [file("/Users/brightadu/Documents/Claude/Projects/fungiforge/.nf-test/tests/2d9109c6fc0ee728fee07d367b5d5bbf/output/S1.master.tsv")]
                
    //----

    //run process
    PROVENANCE.run(input.toArray())

    if (PROVENANCE.output){

        // consumes all named output channels and stores items in a json file
        PROVENANCE.out.getNames().each { name ->
            serializeChannel(name, PROVENANCE.out.getProperty(name), jsonOutput, params.nf_test_output)
        }	  

        // consumes all unnamed output channels and stores items in a json file
        def array = PROVENANCE.out as List<Object>
        def i = 0
        array.each { output ->
