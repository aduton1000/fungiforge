...
include { RESISTANCE } from '/Users/brightadu/Documents/Claude/Projects/fungiforge/modules/stage09_resistance.nf'
...
workflow {
    ...
    input = []
                ...
                input[0] = [[id:'S1', assembly_mode:'longread', compartment:'AIR', facility:'F1', season:'Dry'], file("/Users/brightadu/Documents/Claude/Projects/fungiforge/test/samplesheet.test.csv"), file("/Users/brightadu/Documents/Claude/Projects/fungiforge/assets/NO_ONT"), file("/Users/brightadu/Documents/Claude/Projects/fungiforge/assets/NO_R1"), file("/Users/brightadu/Documents/Claude/Projects/fungiforge/assets/NO_R2"), file("/Users/brightadu/Documents/Claude/Projects/fungiforge/test/reads/TESTFUN01.ont.fastq.gz")]
                
    //----

    //run process
    RESISTANCE.run(input.toArray())

    if (RESISTANCE.output){

        // consumes all named output channels and stores items in a json file
        RESISTANCE.out.getNames().each { name ->
            serializeChannel(name, RESISTANCE.out.getProperty(name), jsonOutput, params.nf_test_output)
        }	  

        // consumes all unnamed output channels and stores items in a json file
        def array = RESISTANCE.out as List<Object>
        def i = 0
        array.each { output ->
