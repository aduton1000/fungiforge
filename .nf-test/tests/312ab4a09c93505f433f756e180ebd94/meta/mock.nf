...
include { SR_ASSEMBLE } from '/Users/brightadu/Documents/Claude/Projects/fungiforge/modules/stage02b_srassemble.nf'
...
workflow {
    ...
    input = []
                ...
                input[0] = [[id:'S1', assembly_mode:'shortread', compartment:'AIR', facility:'F1', season:'Dry'], file("/Users/brightadu/Documents/Claude/Projects/fungiforge/assets/NO_ONT"), file("/Users/brightadu/Documents/Claude/Projects/fungiforge/test/reads/TESTFUN02_R1.fastq.gz"), file("/Users/brightadu/Documents/Claude/Projects/fungiforge/test/reads/TESTFUN02_R2.fastq.gz")]
                
    //----

    //run process
    SR_ASSEMBLE.run(input.toArray())

    if (SR_ASSEMBLE.output){

        // consumes all named output channels and stores items in a json file
        SR_ASSEMBLE.out.getNames().each { name ->
            serializeChannel(name, SR_ASSEMBLE.out.getProperty(name), jsonOutput, params.nf_test_output)
        }	  

        // consumes all unnamed output channels and stores items in a json file
        def array = SR_ASSEMBLE.out as List<Object>
        def i = 0
        array.each { output ->
