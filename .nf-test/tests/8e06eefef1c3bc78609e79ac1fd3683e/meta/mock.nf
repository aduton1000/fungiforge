...
include { MOBILE } from '/Users/brightadu/Documents/Claude/Projects/fungiforge/modules/stage10_mobile.nf'
...
workflow {
    ...
    input = []
                ...
                input[0] = [[id:'S1', assembly_mode:'longread', compartment:'AIR', facility:'F1', season:'Dry'], file("/Users/brightadu/Documents/Claude/Projects/fungiforge/test/samplesheet.test.csv"), file("/Users/brightadu/Documents/Claude/Projects/fungiforge/assets/NO_ONT")]
                
    //----

    //run process
    MOBILE.run(input.toArray())

    if (MOBILE.output){

        // consumes all named output channels and stores items in a json file
        MOBILE.out.getNames().each { name ->
            serializeChannel(name, MOBILE.out.getProperty(name), jsonOutput, params.nf_test_output)
        }	  

        // consumes all unnamed output channels and stores items in a json file
        def array = MOBILE.out as List<Object>
        def i = 0
        array.each { output ->
