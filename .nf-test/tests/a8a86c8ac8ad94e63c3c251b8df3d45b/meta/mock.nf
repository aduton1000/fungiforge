...
include { MEDAKA } from '/Users/brightadu/Documents/Claude/Projects/fungiforge/modules/stage03_polish.nf'
...
workflow {
    ...
    input = []
                ...
                input[0] = [[id:'S1', assembly_mode:'longread', compartment:'AIR', facility:'F1', season:'Dry'], file("/Users/brightadu/Documents/Claude/Projects/fungiforge/test/samplesheet.test.csv"), file("/Users/brightadu/Documents/Claude/Projects/fungiforge/test/reads/TESTFUN02.ont.fastq.gz")]
                
    //----

    //run process
    MEDAKA.run(input.toArray())

    if (MEDAKA.output){

        // consumes all named output channels and stores items in a json file
        MEDAKA.out.getNames().each { name ->
            serializeChannel(name, MEDAKA.out.getProperty(name), jsonOutput, params.nf_test_output)
        }	  

        // consumes all unnamed output channels and stores items in a json file
        def array = MEDAKA.out as List<Object>
        def i = 0
        array.each { output ->
