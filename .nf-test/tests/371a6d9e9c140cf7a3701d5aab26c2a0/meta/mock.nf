...
include { resolve_path } from '/Users/brightadu/Documents/Claude/Projects/fungiforge/main.nf'
...
workflow {
    ...
    def functionResult = resolve_path.invoke_a(input.toArray())
