...
include { parse_row } from '/Users/brightadu/Documents/Claude/Projects/fungiforge/main.nf'
...
workflow {
    ...
    def functionResult = parse_row.invoke_a(input.toArray())
