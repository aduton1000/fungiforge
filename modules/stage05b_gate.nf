...
process GATE {
  ...
  def skipped = reason.startsWith('read_triage')
    ? '["kmer", "assemble", "medaka", "polish", "decontam", "organelle", "assembly_qc", "repeatmask", "predict", "eggnog", "interproscan", "annotate", "identify", "busco_lineage", "resistance", "mobile", "bgc", "novelty", "extras"]'
