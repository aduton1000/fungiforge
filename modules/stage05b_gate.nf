...
// repeat masking, annotation, identification, resistance, mobile, BGC, novelty and extras are
// not run). The isolate gets a `gate` stage JSON with status `skipped` and the reason, so its
...
process GATE {
  ...
  def skipped = reason.startsWith('read_triage')
    ? '["kmer", "assemble", "medaka", "polish", "decontam", "assembly_qc", "repeatmask", "annotate", "identify", "resistance", "mobile", "bgc", "novelty", "extras"]'
    : '["repeatmask", "annotate", "identify", "resistance", "mobile", "bgc", "novelty", "extras"]'
  """
  python3 - <<'PY'
  import json
